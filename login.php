...
<div id="register">
    <div id="register-tag">Log In</div>

    <div id="input-group">
        <label for="user-id">E-mail</label><br>
    ...
    <div id = "button" class="Login">
       Login
    </div>
    <div id="input-group">
        <br>
        <label for="notice">If you do not have a User ID , Create an account</label><br>
        <script>
            $(function () {

                $("#button").click(function () {
                    var A = {
                        email: $("input[name='user-id'").val(),
                        password:$("input[name='password'").val()

                    };
                    $.post('login_server.php',A,function (data) {
                        if(data==0){
                            alert("Could not log in.");
                        }else{
                            var CID = $(data).filter("cid").html();
